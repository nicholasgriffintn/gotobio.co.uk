                    ...
                    <div key={`social-link-${index}`}>
                      <a
                        href={`${
                          network.network === 'facebook'
                            ...
                            ? `https://signal.org/${network.username}`
                            : network.network === 'github'
                            ? `https://github.com/${network.username}`
                            : network.network === 'tiktok'
                            ? `https://tiktok.com/${network.username}`
                            : network.username
                        }`}
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      >
                        {network.network === 'facebook' ? (
                          ...
                          <svg
                            className="w-6 h-6 text-pink-800 fill-current"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512"
                          >
                          ...
                          <svg
                            className="w-6 h-6 text-grey-800 fill-current"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 496 512"
                          >
